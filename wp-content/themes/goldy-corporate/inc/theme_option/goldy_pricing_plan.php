...
// $goldy_fintess_plan = Kirki::get_option( 'goldy_corporate_pricing_plan_content' );

// echo "<pre>";
// print_r($goldy_fintess_plan);
// echo "</pre>";

if(empty(get_theme_mod( 'goldy_corporate_pricing_plan_content')) && !is_plugin_active('slivery-extender/slivery-extender.php')){ ?>
<?php
}else{
$goldy_fintess_plan = Kirki::get_option( 'goldy_corporate_pricing_plan_content' );
...
?>
<div class="corporate_pricing_plan_section">
    <div class="pricing_plan_section_info">
        <div class="pricing_plan_data wow fadeInUp">
            <div class="pricing_plan_title heading_main_title">
                <h2><?php echo esc_html(get_theme_mod('goldy_corporate_pricing_plan_main_title', 'Pricing Plan'));?></h2>
